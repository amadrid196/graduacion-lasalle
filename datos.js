...
const MENSAJE_PRINCIPAL = {
  ...
  mensaje: "Hoy no solo celebramos una graduación — celebramos el valor de cada primero: el primer amigo, la primera letra, el primer logro. Estos niños llegaron como semillas llenas de posibilidad, y hoy florecen ante nosotros listos para el mundo que les espera."
};
